...
<br>==<b>Recuerda:</b> siempre revisar pulso para identificar PC.== 
...
<br>
![Texto alternativo descriptivo](../assets/images/medic/med-order1.png)
...
<br>
<br>
![Texto alternativo descriptivo](../assets/images/medic/med-order2.png)
...
|:----------|:-------------------------|:-------------------|:-----------------|
| Riesgo PC | `<20`                    | `<51/34`           | -                |
| Inestable | `BR: <40` <br>`TQ: >190` | `<80/40`           | `II`* `III` `IV` |
...
| Epinephrine        | - Aumenta la probabilidad de reanimación. <br>- Aumenta la frecuencia cardíaca <br>- Aumenta la presión arterial. |
| Metoprolol         | - Disminuye la frecuencia cardíaca<br>- Disminuye la presión arterial.                                            |
| Morphine           | - Suprime el dolor <br>- Disminuye la frecuencia cardíaca <br>- Disminuye la presión arterial                     |
